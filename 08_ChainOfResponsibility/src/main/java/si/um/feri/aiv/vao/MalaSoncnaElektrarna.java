...
//    private int id=1;
    ...
    private LocalDate datumVgradnje = LocalDate.from(timestamp);
    private LocalDate datumZadnjegaPregleda = LocalDate.of(2023, 7, 15);
    private LocalDate datumVzdrzevalnegaServisa = LocalDate.of(2019, 9, 15);
